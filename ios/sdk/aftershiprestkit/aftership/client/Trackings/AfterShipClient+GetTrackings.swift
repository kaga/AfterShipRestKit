...
/**
The GetTrackingRequestParameters is a struct that store configuration for looking up a single tracking.
- note: advanced developers can modify the properties after initialization (i.e. TrackingField missing a property )
*/
