...
TEST_DEMO_APP_CMD="xcodebuild -scheme AfterShipApiDemoiOS -workspace ./ios/aftership.xcworkspace -destination 'platform=iOS Simulator,name=iPhone 6S,OS=9.3' clean test"
